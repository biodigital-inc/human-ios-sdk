...
/// \param view the HKHuman object for this event
///
/// \param annotationPicked the ID of the picked annotation
///
- (void)human:(HKHuman * _Nonnull)view annotationPicked:(NSString * _Nonnull)annotationPicked;
...
/// Deprecated.  Use moduleDownloaded instead
/// Returns true if a model is on disk and available for offline use
...
/// default is true
  HumanUIOptionsTools = 1,
/// show or hide the current module/chapter title and description
/// default is true
  HumanUIOptionsInfo = 2,
/// show or hide UI for interacting with animations (play/pause, timeline slider)
/// default is true
  HumanUIOptionsAnimation = 3,
/// show or hide pagination controls
/// default is true
  HumanUIOptionsTour = 4,
/// show a help button for UI instruction panel
/// default is true
  HumanUIOptionsHelp = 5,
/// show a searchable tree of objects in the scene
/// default is true
  HumanUIOptionsObjectTree = 6,
/// show a button that resets the scene
  HumanUIOptionsReset = 7,
/// show or hide all navigation UI
/// default is true
  HumanUIOptionsNav = 8,
/// show or hide anatomy labels
/// default is true
  HumanUIOptionsAnatomyLabels = 9,
/// enable or disable the Draw feature
/// default is true
  HumanUIOptionsDraw = 10,
/// enable or disable quizzing
/// default is true
  HumanUIOptionsQuizEnabled = 11,
/// show the label list in the info panel
/// default is false
  HumanUIOptionsLabelList = 12,
/// show visiblilty layers conrols
/// default is false
  HumanUIOptionsLayers = 13,
/// turn on on-demand loading
  HumanUIOptionsOnDemand = 14,
/// turn on quiz lock
  HumanUIOptionsQuizLock = 15,
/// enable/disable audio controls
/// default is enabled
  HumanUIOptionsAudio = 16,
/// set to true to show the tutorial on the next model load
/// default is disabled
  HumanUIOptionsTutorial = 17,
/// HIDDEN disable the link out from the BioDigital logo to our website
  HumanUIOptionsNolink = 18,
/// HIDDEN set to false to hide the BioDigital logo in the viewer
  HumanUIOptionsLogo = 19,
};


SWIFT_CLASS("_TtC8HumanKit9IAPHelper")
...
@interface IAPHelper (SWIFT_EXTENSION(HumanKit)) <SKProductsRequestDelegate>
...
@interface IAPHelper (SWIFT_EXTENSION(HumanKit)) <SKPaymentTransactionObserver>
